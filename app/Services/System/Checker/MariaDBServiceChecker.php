...
class MariaDBServiceChecker extends BaseSystemServiceInfo implements SystemServiceInfo
{
    ...
    {
        return $this->getServiceSystem('mariadb', []);
    }

    public function getDockerContainer(): array
    {
        return $this->getServiceInDockerContainer('mariadb', []);
    }
}
