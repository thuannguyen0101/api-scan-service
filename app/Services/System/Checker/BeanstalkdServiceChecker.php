...
class BeanstalkdServiceChecker extends BaseSystemServiceInfo implements SystemServiceInfo
{
    ...
    {
        return $this->getServiceSystem('beanstalkd', []);
    }

    public function getDockerContainer(): array
    {
        return $this->getServiceInDockerContainer('beanstalkd', []);
    }
}
