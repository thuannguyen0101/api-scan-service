...
class NginxServiceChecker extends BaseSystemServiceInfo implements SystemServiceInfo
{
    ...
    {
        return $this->getServiceSystem('nginx', []);
    }

    public function getDockerContainer(): array
    {
        return $this->getServiceInDockerContainer('nginx', []);
    }
}
