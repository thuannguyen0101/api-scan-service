...
class PhpServiceChecker extends BaseSystemServiceInfo implements SystemServiceInfo
{
    ...
    {
        return $this->getServiceSystem('php', ['phpsessionclean.service']);
    }

    public function getDockerContainer(): array
    {
        return $this->getServiceInDockerContainer('php');
    }
}
