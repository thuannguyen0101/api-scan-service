...
class ElasticsearchServiceChecker extends BaseSystemServiceInfo implements SystemServiceInfo
{
    ...
    {
        return $this->getServiceSystem('elasticsearch', []);
    }

    public function getDockerContainer(): array
    {
        return $this->getServiceInDockerContainer('elasticsearch', []);
    }
}
